...
const defaultItems = [
  ...
  },
  {
    ...
    tools: 'React, HTML, CSS, Figma, Git, Jira',
    desc: `
    - DJ플레이리스트를 생성, 관리하는 관리자 페이지 개발 프로젝트
  ...
  },
  {
    ...
    desc: `
    - 기업의 정체성 및 국내 영업부 담당자 요구 사항을 반영한 디자인 가이드 제작
    - 시선을 사로잡는 비비드한 컬러와 컨텐츠의 이해를 돕는 이미지를 배치하여 개발
    - css, javascript를 사용하여 동적 요소 개발
    `,
    url: '',
    tool: 'html',
  },
  {
    ...
    desc: `
    - 기업용 자원 관리(ERP) 시스템의 사용자 인터페이스 마크업 작업
  ...
  },
  {
    ...
    company: '',
    private: false,
    title: '기업 홍보용 홈페이지 포트폴리오 작업',
    role: '목업 개발',
    tools: 'HTML, CSS',
    desc: `
    - 기업용 자원 관리(ERP) 시스템의 사용자 인터페이스 마크업 작업
    `,
    url: 'http://seoddaddo.woobi.co.kr/src/assan/html/main.html',
    tool: 'html',
    thumbnail: assan,
  ...
  },
  {
    ...
    - 기업용 자원 관리(ERP) 시스템의 사용자 인터페이스 마크업 작업
    `,
    url: 'http://seoddaddo.woobi.co.kr/src/unify/html/main.html',
    tool: 'html',
    thumbnail: unify,
  },
  {
    ...
    - 기업용 자원 관리(ERP) 시스템의 사용자 인터페이스 마크업 작업
    `,
    url: 'http://seoddaddo.woobi.co.kr/src/rentcar/html/main.html',
    tool: 'html',
    thumbnail: rent,
  },
];
